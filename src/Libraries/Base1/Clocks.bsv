...
import "BVI" SyncFIFO =
module vSyncFIFO_Ungenq #(Integer depthIn
                  )(
                    Clock sClkIn, Reset sRstIn,
                    Clock dClkIn, Reset dRstIn,
                    SyncFIFOIfc #(a) ifc)
...
import "BVI" SyncFIFO =
module vSyncFIFO_Ungdeq #(Integer depthIn
                  )(
                    Clock sClkIn, Reset sRstIn,
                    Clock dClkIn, Reset dRstIn,
                    SyncFIFOIfc #(a) ifc)
...
import "BVI" SyncFIFO =
module vSyncFIFO_Ung #(Integer depthIn
                  )(
                    Clock sClkIn, Reset sRstIn,
                    Clock dClkIn, Reset dRstIn,
                    SyncFIFOIfc #(a) ifc)
   ...
   if (valueOf(sa) == 0) begin
     ...
     if (depthIn == 1) begin
       ...
       if (ugenq == True && ugdeq == True)
         ifc_lv = vSyncFIFO_Ung(depthIn, sClkIn, sRstIn, dClkIn, dRstIn) ;
       else if (ugenq == True && ugdeq == False)
         ifc_lv = vSyncFIFO_Ungenq(depthIn, sClkIn, sRstIn, dClkIn, dRstIn) ;
       else if (ugenq == False && ugdeq == True)
         ifc_lv = vSyncFIFO_Ungdeq(depthIn, sClkIn, sRstIn, dClkIn, dRstIn) ;
       else
         ifc_lv = vSyncFIFO(depthIn, sClkIn, sRstIn, dClkIn, dRstIn) ;
     end
     (*hide*)
     _ifc <- ifc_lv;
   end
